  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="add-startup.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white bg-gradient-primary" href="my-startup.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">view_in_ar</i>
            </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">My Startup</h6>
              </div>
            </div>
            ...
            <div class="table-responsive p-0">
                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        <?php
                            $getStartup = mysqli_query($conn, "select * from startup where email = '$_SESSION[user_email]'");
                            $i = 0;
                        ...
                        <tr>
                            ...
                            <td><a href="startup-detail.php?id=<?php echo $row['id']; ?>">View Detail</a></td>
                            <td><a href="add-startup.php?id=<?php echo $row['id']; ?>">Edit</a></td>
                            <td><a href="my-startup.php?ID=<?php echo $row['id']; ?>">Delete</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
...
if(isset($_GET['ID'])){
    $id = $_GET['ID'];
    $delete = mysqli_query($conn, "DELETE FROM `startup` WHERE Id = '$id'");
    if($delete)
    {
        echo "<script>alert('Startup Deleted Successfully!!');window.location='my-startup.php';</script>";
    }
}
